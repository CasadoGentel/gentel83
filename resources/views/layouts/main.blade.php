<body class="@bodyclass">
	...
	<nav class="pcoded-navbar @@menuclass theme-horizontal">
		<div class="navbar-wrapper container container">
			<div class="navbar-content scroll-div sidenav-horizontal" id="layout-sidenav" >
					...
					<ul class="nav pcoded-inner-navbar sidenav-inner">
						@include('../layouts/menu-list-horizontal')
					</ul>
